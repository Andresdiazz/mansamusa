          ...
          children: [
            ...
            Row(
              children: <Widget>[
                Padding(
                  ...
                  child: Text("Eje Temático", style: TextStyle(fontSize: 23, color: Color(0xffAC7830)),),
                ),
                SizedBox(width: 10,),
                Expanded(child: Container(height: 1.5, decoration: BoxDecoration(color: Color(0xffAC7830)),))
              ],
            ),
            SizedBox(height: 15,),
            EjeTematico(),
            ...
            Row(
              children: <Widget>[
                Padding(
                  padding: const EdgeInsets.only(left: 15),
                  child: Text("Temas de Interés", style: TextStyle(fontSize: 23, color: Color(0xffAC7830)),),
                ),
                SizedBox(width: 10,),
                Expanded(child: Container( height: 1.5, decoration: BoxDecoration(color: Color(0xffAC7830)),))
              ],
            ...
            Row(
              children: <Widget>[
                Padding(
                  padding: const EdgeInsets.only(left: 15),
                  child: Text("Aprende Jugando", style: TextStyle(fontSize: 23, color: Color(0xffAC7830)),),
                ),
                SizedBox(width: 10,),
                Expanded(child: Container( height: 1.5, decoration: BoxDecoration(color: Color(0xffAC7830)),))
              ],
